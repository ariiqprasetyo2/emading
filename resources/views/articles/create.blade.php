        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="form-card p-4">
                    <h3 class="fw-bold mb-4" style="color: var(--text-primary);"><i class="fas fa-plus me-2"></i>Buat Artikel Baru</h3>
                    ...
                    <form method="POST" action="{{ route('articles.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('articles.index') }}" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Kembali</a>
                        </div>
                    </form>
                </div>
            </div>
