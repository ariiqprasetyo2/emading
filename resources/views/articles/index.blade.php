            ...
            <div class="col-md-10">
                ...
                <div class="article-card p-4">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        <div>
                            ...
                            <small class="text-muted">
                                <i class="fas fa-user"></i> {{ $article->user->nama }} ({{ ucfirst($article->user->role) }}) | 
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            ...
                            @endif
                            @if(auth()->check() && (auth()->user()->role === 'admin' || $article->id_user == auth()->user()->id_user))
                            ...
                            @endif
                            <a href="{{ route('articles.pdf', $article->id_artikel) }}" class="btn btn-danger btn-sm me-1" title="Download PDF"><i class="fas fa-file-pdf"></i></a>
                ...
                @if($articles->count() == 0)
                    <div class="article-card p-4 text-center">
                        ...
                        <p class="text-muted">{{ request('search') ? 'Tidak ditemukan artikel dengan kata kunci "' . request('search') . '"' : 'Belum ada artikel yang dibuat.' }}</p>
                    </div>
                @endif
                {{ $articles->links() }}
            </div>
