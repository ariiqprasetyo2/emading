...
<body>
    ...
    <div class="main-content">
        ...
        <div class="guru-card">
            <h4 class="fw-bold mb-4" style="color: var(--text-primary);"><i class="fas fa-newspaper text-primary me-2"></i>Artikel Saya</h4>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <br><small style="color: var(--text-secondary);">{{ Str::limit($article->isi, 60) }}</small>
                            </td>
                            ...
                            <td>
                                <div class="btn-group-vertical btn-group-sm">
                                    ...
                                    <a href="{{ route('articles.edit', $article->id_artikel) }}" class="btn btn-secondary btn-sm">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    <a href="{{ route('articles.pdf', $article->id_artikel) }}" class="btn btn-danger btn-sm">
