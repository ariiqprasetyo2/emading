...
<head>
    <meta charset="UTF-8">
    <title>Dashboard Murid - E-Mading</title>
        ...
        <div class="row g-4">
            <div class="col-md-3">
                <div class="stat-card">
                    ...
                    <div class="stat-number">{{ \App\Models\Artikel::where('id_user', auth()->user()->id_user)->count() }}</div>
            ...
            <div class="col-md-3">
                <div class="stat-card">
                    ...
                    <div class="stat-number">{{ \App\Models\Artikel::where('id_user', auth()->user()->id_user)->where('status', 'publish')->count() }}</div>
            ...
            <div class="col-md-3">
                <div class="stat-card">
                    ...
                    <div class="stat-number">{{ \App\Models\Artikel::where('id_user', auth()->user()->id_user)->where('status', 'draft')->count() }}</div>
                    <p class="mb-0" style="color: var(--text-secondary);">Artikel Draft</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="stat-card">
                    <i class="fas fa-comments fa-3x mb-3" style="color: #9C27B0;"></i>
                    <div class="stat-number">{{ \App\Models\Komentar::where('id_user', auth()->user()->id_user)->count() }}</div>
                    <p class="mb-0" style="color: var(--text-secondary);">Komentar Saya</p>
                </div>
            </div>
        </div>
        ...
        <div class="row g-4 mt-4">
            <div class="col-md-6">
                <div class="murid-card">
                    ...
                    <p style="color: var(--text-secondary);">Bagikan ide dan pengalaman Anda dengan menulis artikel untuk mading digital sekolah.</p>
            ...
            <div class="col-md-6">
                <div class="murid-card">
                    <h5 class="fw-bold mb-3" style="color: var(--text-primary);"><i class="fas fa-book text-success me-2"></i>Baca Artikel</h5>
                    <p style="color: var(--text-secondary);">Jelajahi artikel-artikel menarik dari teman-teman dan guru di mading digital sekolah.</p>
