...
<head>
    ...
    <title>Admin Dashboard - E-Mading</title>
        ...
        <div class="row g-4">
            <div class="col-md-3">
                <div class="stat-card">
                    ...
                    <p class="mb-0" style="color: var(--text-secondary);">Total Users</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="stat-card">
                    <i class="fas fa-newspaper fa-3x mb-3" style="color: #4CAF50;"></i>
                    <div class="stat-number">{{ $stats['total_articles'] }}</div>
                    <p class="mb-0" style="color: var(--text-secondary);">Total Artikel</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="stat-card">
                    ...
                    <p class="mb-0" style="color: var(--text-secondary);">Perlu Verifikasi</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="stat-card">
                    <i class="fas fa-tags fa-3x mb-3" style="color: #9C27B0;"></i>
                    <div class="stat-number">{{ $stats['total_categories'] }}</div>
                    <p class="mb-0" style="color: var(--text-secondary);">Kategori</p>
                </div>
            </div>
        </div>
        ...
        <div class="row g-4 mt-4">
            <div class="col-md-6">
                <div class="admin-card">
                    <h5 class="fw-bold mb-3" style="color: var(--text-primary);"><i class="fas fa-tags text-primary me-2"></i>Kelola Kategori</h5>
                    <p style="color: var(--text-secondary);">Tambah, edit, dan hapus kategori artikel untuk mengorganisir konten mading digital.</p>
            ...
            <div class="col-md-6">
                <div class="admin-card">
                    <h5 class="fw-bold mb-3" style="color: var(--text-primary);"><i class="fas fa-check-circle text-success me-2"></i>Verifikasi Artikel</h5>
                    <p style="color: var(--text-secondary);">Review dan setujui artikel yang ditulis oleh siswa dan guru sebelum dipublikasikan.</p>
                    <a href="{{ route('admin.articles') }}" class="btn btn-success">
                        <i class="fas fa-check me-2"></i>Verifikasi Artikel
                    </a>
                </div>
            </div>
            <div class="col-md-6">
                <div class="admin-card">
                    <h5 class="fw-bold mb-3" style="color: var(--text-primary);"><i class="fas fa-users text-info me-2"></i>Kelola User</h5>
                    <p style="color: var(--text-secondary);">Manajemen akun pengguna sistem, tambah user baru, edit profil, dan atur hak akses.</p>
            ...
            <div class="col-md-6">
                <div class="admin-card">
                    <h5 class="fw-bold mb-3" style="color: var(--text-primary);"><i class="fas fa-chart-bar text-warning me-2"></i>Laporan Sistem</h5>
                    <p style="color: var(--text-secondary);">Lihat statistik dan analytics sistem, laporan aktivitas pengguna dan performa mading.</p>
