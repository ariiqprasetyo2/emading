        ...
        <div class="row">
            <div class="col-md-8">
                <div class="admin-card p-4">
                    <h4 class="fw-bold mb-4 text-white"><i class="fas fa-tags text-primary me-2"></i>Daftar Kategori</h4>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-warning btn-sm" onclick="editCategory({{ $category->id_kategori }}, '{{ $category->nama_kategori }}')">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <form method="POST" action="{{ route('admin.categories.delete', $category->id_kategori) }}" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus kategori ini?')">
                                            @csrf
                                            @method('DELETE')
            ...
            <div class="col-md-4">
                <div class="admin-card p-4">
                    <h5 class="fw-bold mb-4 text-white"><i class="fas fa-plus text-success me-2"></i>Tambah Kategori</h5>
                    ...
                    <form method="POST" action="{{ route('admin.categories.store') }}" id="categoryForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_kategori" class="form-control" id="namaKategori" required>
                        </div>
